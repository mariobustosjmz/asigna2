...
@section('crear')
        ...
        {!! Form::open( ['route'  => 'asignaciones.store','method' => 'POST' ])  !!}
                ...
                <div class="modal fade" id="modal_crear_equipo"  role="document" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="">&times;</button>
                                <h4 class="modal-title" id="myModalLabel"><i class="ace-icon fa fa-laptop"></i>&nbsp;Nuevo Equipo</h4>
                            </div>
                                    ...
                                    <div class="container-fluid">
                                        ...
                                        <div class="widget-body">
                                            <div class="widget-main">
                                                ...
                                                @include('asignaciones.partials.fields')
