...
@section('content')
    {!! Form::model($usuarios, ['route'  => ['usuarios.update'],'method' => 'PUT' ])  !!}

    <div class="modal fade" id="modal_editar_user"  role="document" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="">&times;</button>
                    <h4 class="modal-title" id="myModalLabel"> <i class="ace-icon fa fa-pencil-square-o"></i>&nbsp; Editar Usuario</h4>
                </div>
