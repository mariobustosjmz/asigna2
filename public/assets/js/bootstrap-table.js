...
var contador=0;
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (typeof this.options.toolbar === 'string') {
            $(sprintf('<div  id="bars-' +contador + '-table"   class="bars pull-%s"></div>', this.options.toolbarAlign))
        ...
        html = [sprintf('<div id="columns-' +contador + '-table"  class="columns columns-%s btn-group pull-%s">',
        ...
        if (this.options.showRefresh) {
            html.push(sprintf('<button class="btn btn-primary' + (this.options.iconSize === undefined ? '' : ' btn-' + this.options.iconSize) + '" type="button" name="refresh" title="%s">',
        ...
        if (this.options.showToggle) {
            html.push(sprintf('<button class="btn btn-primary' + (this.options.iconSize === undefined ? '' : ' btn-' + this.options.iconSize) + '" type="button" name="toggle" title="%s">',
        ...
        if (this.options.showColumns) {
            html.push(sprintf('<div  class="keep-open btn-group" title="%s">',
                ...
                '<button type="button" class="btn btn-primary' + (this.options.iconSize == undefined ? '' : ' btn-' + this.options.iconSize) + ' dropdown-toggle" data-toggle="dropdown">',
        ...
        if (this.options.search) {
            html = [];
            html.push(
                '<div id="div-' +contador + '-table"  class="pull-' + this.options.searchAlign + ' search buscar">',
                sprintf('<input  id="search-' +contador + '-table"     class="form-control' + (this.options.iconSize === undefined ? '' : ' input-' + this.options.iconSize) + '" type="text" placeholder="%s">',
    ...
    BootstrapTable.prototype.initBody = function (fixedScroll) {
        ...
        if (!html.length) {
            html.push('<tr class="no-records-found">',
                sprintf('<td colspan="%s">"No se encontraron Registros"</td>',
